...
export const BODY_AREA_GROUPS:BodyAreaGroup[]=[
  {id:'upper',label:'Upper body',icon:'↑',areas:[['neck','Neck'],['shoulders','Shoulders'],['chest','Chest'],['upper_back','Upper back'],['biceps','Upper arms'],['elbows','Elbows'],['forearms','Forearms'],['wrists','Wrists'],['hands','Hands']]},
