...
const categories: Array<['all' | Category,string]> = [['all','All'],['upper','Upper'],['lower','Lower'],['core','Core'],['conditioning','Condition'],['mobility','Mobility'],['stretching','Stretch'],['mindfulness','Meditate']]
